/* Tamaguino
original code by Alojz Jakob: https://github.com/alojzjakob/Tamaguino
slight modifications by Jack Everson: https://github.com/JackEverson/Tamaguino
...
#include <SPI.h>
#include <Wire.h>
#include <Adafruit_GFX.h>               // make sure to use version 1.1.5
#include <Adafruit_SSD1306.h>           // make sure to use version 1.1.2, failure to do so will result in not enough memory error while compiling/flashing
